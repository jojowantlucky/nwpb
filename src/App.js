    ...
    <div style={{ 
      ...
      >
        <div style={{ 
          ...
          <div className="desktop-nav" style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
            <a onClick={() => scrollToSection('home')} style={{ color: '#121212', fontWeight: 600, fontSize: '15px', textDecoration: 'none', cursor: 'pointer' }}>Home</a>
            <a onClick={() => scrollToSection('about')} style={{ color: '#121212', fontWeight: 600, fontSize: '15px', textDecoration: 'none', cursor: 'pointer' }}>About</a>
            <a onClick={() => scrollToSection('team')} style={{ color: '#121212', fontWeight: 600, fontSize: '15px', textDecoration: 'none', cursor: 'pointer' }}>Team</a>
            <a onClick={() => scrollToSection('booths')} style={{ color: '#121212', fontWeight: 600, fontSize: '15px', textDecoration: 'none', cursor: 'pointer' }}>Booths</a>
            <a onClick={() => scrollToSection('contact')} style={{ color: '#121212', fontWeight: 600, fontSize: '15px', textDecoration: 'none', cursor: 'pointer' }}>Contact</a>
            <a href="https://noteworthy-djs.checkcherry.com/users/sign_in" target="_blank" rel="noopener noreferrer" style={{ color: '#121212', fontWeight: 600, fontSize: '15px', textDecoration: 'none' }}>Login</a>
        ...
        >
          <a onClick={() => { scrollToSection('home'); setMobileMenuOpen(false); }} style={{ color: '#121212', fontWeight: 600, fontSize: '16px', textDecoration: 'none', cursor: 'pointer', padding: '16px 24px', borderBottom: '1px solid rgba(18, 18, 18, 0.05)' }}>Home</a>
          <a onClick={() => { scrollToSection('about'); setMobileMenuOpen(false); }} style={{ color: '#121212', fontWeight: 600, fontSize: '16px', textDecoration: 'none', cursor: 'pointer', padding: '16px 24px', borderBottom: '1px solid rgba(18, 18, 18, 0.05)' }}>About</a>
          <a onClick={() => { scrollToSection('team'); setMobileMenuOpen(false); }} style={{ color: '#121212', fontWeight: 600, fontSize: '16px', textDecoration: 'none', cursor: 'pointer', padding: '16px 24px', borderBottom: '1px solid rgba(18, 18, 18, 0.05)' }}>Team</a>
          <a onClick={() => { scrollToSection('booths'); setMobileMenuOpen(false); }} style={{ color: '#121212', fontWeight: 600, fontSize: '16px', textDecoration: 'none', cursor: 'pointer', padding: '16px 24px', borderBottom: '1px solid rgba(18, 18, 18, 0.05)' }}>Booths</a>
          <a onClick={() => { scrollToSection('contact'); setMobileMenuOpen(false); }} style={{ color: '#121212', fontWeight: 600, fontSize: '16px', textDecoration: 'none', cursor: 'pointer', padding: '16px 24px', borderBottom: '1px solid rgba(18, 18, 18, 0.05)' }}>Contact</a>
          <a href="https://noteworthy-djs.checkcherry.com/users/sign_in" target="_blank" rel="noopener noreferrer" style={{ color: '#121212', fontWeight: 600, fontSize: '16px', textDecoration: 'none', padding: '16px 24px', borderBottom: '1px solid rgba(18, 18, 18, 0.05)' }}>Login</a>
      ...
      <section id="booths" className="section-padding" style={{ 
        ...
        >
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FAFAF8" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={{
            ...
            >
              ...
              <div style={{ padding: '32px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                <h3 className="display-font" style={{
                  fontSize: '32px', fontWeight: 600, color: '#121212', marginBottom: '16px'
                }}>
                  Standard Photo Books
                </h3>
                <p className="body-font" style={{
                  fontSize: '16px', color: '#555555', lineHeight: 1.7, marginBottom: '24px', flexGrow: 1
                }}>
                  ...
                  {['Multiple template designs', 'High-quality printing', 'Professional binding', 'Quick turnaround'].map((feature, idx) => (
                    <li key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                      <div style={{
                        ...
                        <Check size={14} color="#ff3a7c" strokeWidth={3} />
                      </div>
                      <span className="body-font" style={{ color: '#555555', fontSize: '15px' }}>{feature}</span>
                    </li>
                  ))}
                </ul>
            ...
            >
              <div className="body-font" style={{
                ...
                background: 'linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%)',
                color: '#FAFAF8', padding: '8px 20px', borderRadius: '20px',
                  ...
                  {['Fully customized designs', 'Your branding & logos', 'Premium paper options', 'Dedicated design consultation'].map((feature, idx) => (
                    <li key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                      <div style={{
                        ...
                        <Check size={14} color="#FAFAF8" strokeWidth={3} />
                      </div>
                      <span className="body-font" style={{ color: '#555555', fontSize: '15px' }}>{feature}</span>
                    </li>
                  ))}
          ...
          <div style={{
            ...
            {testimonials.map(testimonial => (
              ...
              >
                ...
                <div style={{ marginBottom: '24px' }}>
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} size={20} fill="#ff3a7c" color="#ff3a7c" style={{ display: 'inline-block', marginRight: '4px' }} />
                  ))}
                </div>
                <p className="body-font" style={{
                  fontSize: '17px',
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p className="body-font" style={{
              ...
              <strong style={{ color: '#121212' }}>Join hundreds of satisfied clients</strong> who have trusted us with 
      ...
      <section id="contact" className="section-padding" style={{ 
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                  ...
                  <div>
                    <p className="body-font" style={{ fontSize: '14px', color: '#555555', marginBottom: '4px' }}>Phone</p>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                  ...
                  <div>
                    <p className="body-font" style={{ fontSize: '14px', color: '#555555', marginBottom: '4px' }}>Email</p>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  ...
                  <div>
                    <p className="body-font" style={{ fontSize: '14px', color: '#555555', marginBottom: '4px' }}>Address</p>
                    <p className="body-font" style={{ 
                      fontSize: '17px', 
                      fontWeight: 600, 
                      color: '#121212',
          ...
          <div style={{
            ...
            width: '80%',
            margin: '0 auto',
            background: 'linear-gradient(135deg, rgba(255, 58, 124, 0.02) 0%, rgba(37, 99, 235, 0.02) 100%)'
          }}
                  ...
                  {[1, 2, 3, 4, 5].map((num) => (
                    ...
                    >
                      ...
                      <div style={{ 
                        ...
                        <Image size={40} color="#FAFAF8" strokeWidth={2} style={{ marginBottom: '8px' }} />
                        <p className="body-font" style={{
                          color: '#FAFAF8',
                          fontSize: '14px',
                          fontWeight: 600
            ...
            <div style={{
              ...
              {Array.from({ length: photoBookGallery.imageCount }).map((_, idx) => (
                <div key={idx} onClick={() => setCurrentPhotoBookImage(idx)} style={{
                  ...
                  border: currentPhotoBookImage === idx ? '3px solid #ff3a7c' : '3px solid transparent',
        ...
        <div className="modal-overlay" onClick={() => { setPhotoBookModal(null); setPhotoBookPage(0); }}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '1100px' }}>
            ...
            <div style={{ padding: '48px 40px' }}>
              {/* Title */}
              <h3 className="display-font" style={{
                fontSize: '36px', fontWeight: 600, color: '#121212',
                marginBottom: '8px', textAlign: 'center'
              }}>
                {photoBookModal === 'standard' ? 'Standard Photo Books' : 'Custom Photo Books'}
              </h3>
              <p className="body-font" style={{
                fontSize: '16px', color: '#555555', textAlign: 'center', marginBottom: '40px'
              }}>
                  ...
                  {[1, 2, 3, 4, 5, 6].map((num) => (
                    <div key={num} style={{
                      ...
                      <div style={{
                        ...
                        <Book size={40} color="#ff3a7c" strokeWidth={1.5} style={{ opacity: 0.4 }} />
                      </div>
                      <div style={{ padding: '16px' }}>
                        <p className="body-font" style={{
                          fontSize: '14px', fontWeight: 600, color: '#aaaaaa', textAlign: 'center'
                        }}>
                          Coming Soon
                        </p>
                      </div>
                ...
                <>
                      ...
                      .map((design, idx) => (
                        ...
                        >
                          ...
                          <div style={{ padding: '14px 16px' }}>
                            <p className="body-font" style={{
                              fontSize: '14px', fontWeight: 600, color: '#121212', textAlign: 'center'
                            }}>
                              {design.name}
                            </p>
                          </div>
                  ...
                  <div style={{
                    ...
                    <button
                      ...
                      style={{
                        background: photoBookPage === 0 ? '#f0f0f0' : '#121212',
                        color: photoBookPage === 0 ? '#aaaaaa' : '#FFFFFF',
                      ...
                      {Array.from({ length: Math.ceil(photoBookDesigns.length / DESIGNS_PER_PAGE) }).map((_, idx) => (
                        <div
                          ...
                          style={{
                            ...
                            height: '8px',
                            borderRadius: '4px',
                            background: photoBookPage === idx ? '#2563eb' : '#cccccc',
                            cursor: 'pointer',
                            transition: 'all 0.3s ease'
                          }}
                        />
                    ...
                    <button
                      ...
                      style={{
                        background: (photoBookPage + 1) * DESIGNS_PER_PAGE >= photoBookDesigns.length ? '#f0f0f0' : '#121212',
                        color: (photoBookPage + 1) * DESIGNS_PER_PAGE >= photoBookDesigns.length ? '#aaaaaa' : '#FFFFFF',
                        border: 'none', borderRadius: '8px', padding: '10px 20px',
                  ...
                  {/* Design count */}
                  <p className="body-font" style={{ textAlign: 'center', color: '#aaaaaa', fontSize: '14px', marginBottom: '24px' }}>
            ...
            <div style={{ padding: '48px 40px' }}>
              ...
              <p className="body-font" style={{
                ...
                {backdropModal === 'standard'
                  ...
                  : 'Custom backdrop examples — coming soon!'}
              </p>
                  ...
                  <div key={num} style={{
                    ...
                    <div style={{
                      ...
                      background: backdropModal === 'standard'
                        ...
                        : 'linear-gradient(135deg, #fce4f0 0%, #f8c8e4 100%)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center'
                    }}>
                      {backdropModal === 'standard'
                ...
                {[1, 2, 3, 4, 5].map((num) => (
                  ...
                  >
                    ...
                    <div style={{ 
                      ...
                      <Image size={56} color="#FAFAF8" strokeWidth={2} style={{ marginBottom: '12px' }} />
                      <p className="body-font" style={{
                        color: '#FAFAF8',
                        fontSize: '18px',
                        fontWeight: 600
