                  ...
                  {[
                    ...
                    <li key={idx} style={{
                      ...
                      <div style={{
                        ...
                        <span style={{ color: '#ff3a7c', fontWeight: 'bold', fontSize: '14px' }}>✓</span>
                      </div>
              ...
              <div style={{
                ...
                {[1, 2, 3, 4, 5].map((num) => (
                  <div
                    ...
                    style={{
                      aspectRatio: '3/4',
                      background: photoBookModal === 'standard' 
                  ...
                  >
                    ...
                    <div style={{ 
                      ...
                      <Book size={48} color="#FAFAF8" strokeWidth={2} style={{ marginBottom: '12px' }} />
                      <p className="body-font" style={{
                        color: '#FAFAF8',
                        fontSize: '18px',
                        fontWeight: 600
              ...
              <div style={{
                ...
                {(photoBookModal === 'standard' 
                  ...
                  <div key={idx} style={{
                    ...
                    <Check size={20} color={photoBookModal === 'standard' ? '#ff3a7c' : '#2563eb'} strokeWidth={3} />
                    <span className="body-font" style={{ fontSize: '16px', color: '#555555' }}>
                      {feature}
                    </span>
                  </div>
