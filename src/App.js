...
export default function NoteworthyPhotoBooths() {
	...
	const boothTypes = [
		{
			...
			description:
				'Our open-air booths accommodate groups of any size and can be positioned anywhere at your venue. Professional DSLR camera with customizable backdrop options, perfect for high-traffic events.',
		...
		},
		{
			...
			description:
				'A compact, modern solution perfect for corporate events and smaller venues. Guests can take unlimited photos using a touchscreen interface with digital sharing options.',
		...
		},
		{
			...
			description:
				'An interactive experience featuring a full-length mirror that comes alive with animations and prompts. Touch the mirror to take photos, sign your prints, and enjoy animated emoji stamps for a truly unique photo booth experience.',
	...
	return (
      ...
      `}</style>
			...
			<section
				...
				<div id='booths' style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
					...
					<p
						...
						Noteworthy Photo Booths is Portland's premier photo booth rental company, dedicated to
						creating unforgettable memories for your special events. With years of experience in the
						entertainment industry, we combine cutting-edge technology with exceptional service to
						deliver an experience your guests will love. Every event deserves to be memorable, and
						our mission is to provide top-quality photo booth experiences that bring joy, laughter,
						and lasting memories to weddings, corporate events, and celebrations throughout the
						Pacific Northwest.
					</p>
			...
			{/* Photo Books Section - NWDJ Style */}
			<section
				className='section-padding'
				style={{
					background: '#FFFFFF',
				...
				{/* Photo Book Cards - 2 Column Layout */}
				<div
					style={{
						display: 'grid',
						gridTemplateColumns: 'repeat(2, 1fr)',
					...
					<div
						...
						<p
							style={{ color: '#9b9b9b', fontSize: '14px', lineHeight: 1.6, marginBottom: '16px' }}>
							Choose from our curated selection of professionally designed templates. Perfect for
							guests to take home a keepsake from your event.
						</p>
						<ul
							style={{
								listStyle: 'none',
					...
					<div
						...
						<p
							style={{ color: '#9b9b9b', fontSize: '14px', lineHeight: 1.6, marginBottom: '16px' }}>
							Work with our design team to create a completely unique photo book. Use your branding,
							logos, and custom layouts for a truly personalized keepsake.
						</p>
						<ul
							style={{
								listStyle: 'none',
			...
			<section
				...
				<div
					...
					<div
						...
						<p
							style={{ color: '#9b9b9b', fontSize: '14px', lineHeight: 1.6, marginBottom: '16px' }}>
							Classic solid color backdrops perfect for any event. Choose from our wide selection to
							match your theme.
						</p>
						<ul
							style={{
					...
					<div
						...
						<a
							...
							<div
								...
								<img
									src={`${process.env.PUBLIC_URL}/img/backdrops/sequin/spearmint-sequin.webp`}
									alt='Premium Sequin Backdrops'
									style={{
										width: '100%',
										height: '100%',
										objectFit: 'cover',
					...
					<div
						...
						<p
							style={{ color: '#9b9b9b', fontSize: '14px', lineHeight: 1.6, marginBottom: '16px' }}>
							Browse hundreds of premium backdrop designs from PBBackdrops. Professional quality
							prints perfect for weddings, events, and special occasions.
						</p>
						<ul
							style={{
								listStyle: 'none',
					...
					<div className='badges-grid'>
						{[
							...
							},
							{
								name: 'BBB',
								filename: 'bbb-iframe',
								url: 'https://www.bbb.org/us/or/portland/profile/photo-booth-rental/noteworthy-productions-llc-1296-1000083774',
							},
						].map((badge, idx) => (
							<a
								key={idx}
							...
							<div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
								<div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
									...
									<div>
										<p
											className='body-font'
											style={{ fontSize: '14px', color: '#9b9b9b', marginBottom: '4px' }}>
											Phone
										</p>
										<a
											href='tel:503-770-0382'
							...
							{Array.from({ length: photoBookGallery.imageCount }).map((_, idx) => (
								<div
									...
									style={{
										...
										flexShrink: 0,
										border:
											currentPhotoBookImage === idx ? '3px solid #e86c6c' : '3px solid transparent',
							...
							{photoBookModal === 'standard' ? (
								...
								<>
									<div
										...
										{photoBookDesigns
											.slice(
												photoBookPage * DESIGNS_PER_PAGE,
												(photoBookPage + 1) * DESIGNS_PER_PAGE,
											)
											.map((design, idx) => (
												<div
													key={idx}
														...
														<img
															...
															onError={(e) => {
																...
																e.target.parentElement.innerHTML =
																	'<div style="color:#aaa;font-size:13px;">Preview Coming Soon</div>';
															}}
														/>
													</div>
									...
									<div
										...
										<div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
											{Array.from({
												length: Math.ceil(photoBookDesigns.length / DESIGNS_PER_PAGE),
											}).map((_, idx) => (
												<div
													key={idx}
										...
										<button
											...
											style={{
												background:
													(photoBookPage + 1) * DESIGNS_PER_PAGE >= photoBookDesigns.length
														? '#f0f0f0'
														: '#4a4a4a',
												color:
													(photoBookPage + 1) * DESIGNS_PER_PAGE >= photoBookDesigns.length
									...
									<p
										...
										Showing {photoBookPage * DESIGNS_PER_PAGE + 1}–
										{Math.min((photoBookPage + 1) * DESIGNS_PER_PAGE, photoBookDesigns.length)} of{' '}
										{photoBookDesigns.length} designs
									</p>
								</>
							)}
